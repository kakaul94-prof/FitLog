...
// Body of the "Saved Meals" tab in LibraryPage. Saved meals have no add action
// in the header — they're created from the diary (see the note below).
  ...
  return (
    <div className="space-y-3 p-4">
      <p className="text-xs text-muted-foreground">
        ...
        Add meals to a day from the food picker’s “Meals” tab. Create one on the
        diary: long-press an entry → “Select multiple” → “Save as meal”.
      </p>
          ...
          <Card key={m.id} className="overflow-hidden">
            <div className="flex items-center gap-2 border-b border-border p-3">
              ...
              <button
                ...
                onClick={() => {
                  if (confirm(`Delete saved meal "${m.name}"?`)) del.mutate(m.id)
                }}
